...
local moneyTrucks ={
 [0] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 1, ["as"] = 1, ["x"] = -5.902, ["y"] = -669.570, ["z"] = 31.944, ["r"] = 180.0, ["breached"] = false},
 [1] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 1, ["as"] = 1, ["x"] = -122.226, ["y"] = 6479.219, ["z"] = 31.051, ["r"] = 131.124, ["breached"] = false},
 [2] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 0, ["as"] = 0, ["x"] = -343.565, ["y"] = -29.775, ["z"] = 47.089, ["r"] = 0.0, ["breached"] = false},
 [3] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 0, ["as"] = 0, ["x"] = -5.902, ["y"] = -669.570, ["z"] = 31.944, ["r"] = 0.0, ["breached"] = false},
 [4] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 0, ["as"] = 0, ["x"] = 254.483, ["y"] = 190.450, ["z"] = 104.448, ["r"] = 0.0, ["breached"] = false},
 [5] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 0, ["as"] = 0, ["x"] = -392.572, ["y"] = 6062.591, ["z"] = 31.104, ["r"] = 0.0, ["breached"] = false},
 [6] =  {["hash"] = GetHashKey("stockade"), ["gs"] = 0, ["as"] = 0, ["x"] = -122.495, ["y"] = 6479.521, ["z"] = 31.047, ["r"] = 136.0, ["breached"] = false} 
}

local moneyGroundEscorts = {
 [0] = {["hash"] = GetHashKey("fib2"), ["x"] = -34.032, ["y"] = -673.547, ["z"] = 31.961, ["r"] = 183.475, ["last"] = 0},
 [1] = {["hash"] = GetHashKey("fib2"), ["x"] = -18.876, ["y"] = -704.382, ["z"] = 31.960, ["r"] = 350.404},
 [2] = {["hash"] = GetHashKey("fib2"), ["x"] = -134.177, ["y"] = 6468.694, ["z"] = 31.064, ["r"] = 142.429, ["last"] = 1},
 [3] = {["hash"] = GetHashKey("fib2"), ["x"] = -110.279, ["y"] = 6486.652, ["z"] = 31.068, ["r"] = 110.960}
}
 ...
 --SetBlipColour(moneyTruckGuardBlip[truckId], 12)
  ...
  if truckId == 0 then
    ...
    --LOAD land Escorts
      ...
      thisMoneyGroundEscort[truckId] = CreateVehicle(GetHashKey("fbi2"), moneyGroundEscorts[truckId]["x"], moneyGroundEscorts[truckId]["y"],moneyGroundEscorts[truckId]["z"],moneyGroundEscorts[truckId]["r"], true, false)
      thisMoneyGroundEscort[truckId + 1 ] = CreateVehicle(GetHashKey("fbi2"), moneyGroundEscorts[truckId + 1 ]["x"], moneyGroundEscorts[truckId + 1 ]["y"],moneyGroundEscorts[truckId + 1 ]["z"],moneyGroundEscorts[truckId + 1 ]["r"], true, false)
...
if truckId == 1 then
    ...
    --LOAD land Escorts
      ...
      thisMoneyGroundEscort[truckId + 1] = CreateVehicle(GetHashKey("fbi2"), moneyGroundEscorts[truckId + 1]["x"], moneyGroundEscorts[truckId + 1]["y"],moneyGroundEscorts[truckId + 1]["z"],moneyGroundEscorts[truckId + 1]["r"], true, false)
      thisMoneyGroundEscort[truckId + 2 ] = CreateVehicle(GetHashKey("fbi2"), moneyGroundEscorts[truckId + 2]["x"], moneyGroundEscorts[truckId + 2]["y"],moneyGroundEscorts[truckId + 2]["z"],moneyGroundEscorts[truckId + 2]["r"], true, false)
...
function checkMoneyTruckTick()
    ...
    for i=0, 6, 1 do
        ...
        if (GetVehicleBodyHealth(thisMoneyTruck) < 5.0) then 
          ...
          -- TriggerServerEvent("mission:complete", tonumber(100000))
